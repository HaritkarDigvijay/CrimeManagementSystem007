	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-6">
				...
				<form id="form" action="ApplicantController?action=RegisterCivilian" method="post" id="fileForm" role="form">
					<fieldset>
						...
						<div class="form-group">
							<label for="firstname"><span class="req">* </span> First
								...
								placeholder="FirstName" name="firstname" id="txt"
						...
						<div class="form-group">
							<label for="lastname"><span class="req">* </span> Last
								name: </label> <input class="form-control" type="text"
								placeholder="LastName" name="lastname" id="txt"
